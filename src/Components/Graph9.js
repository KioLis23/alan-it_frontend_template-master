...
// https://www.amcharts.com/docs/v5/concepts/themes/
    ...
    if (item.product_type == "Категория") {
      if (index === 0) {
        finalData.push({
...
return [<div id="chartdiv9" style={{ width: "40%", height: "200px",right: "0px",top: "2060px" ,position: "absolute" }} />,
<p style={{width: "50%", height: "00px", top: "2000px",right: "-480px", position: "absolute"}}>Продукты "Категория"</p>]}
