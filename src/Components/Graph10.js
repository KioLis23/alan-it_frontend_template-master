...
// https://www.amcharts.com/docs/v5/concepts/themes/
    ...
    if (item.product_type == "Происхождение") {
      if (index === 0) {
        finalData.push({
...
return [<div id="chartdiv10" style={{ width: "40%", height: "200px",right: "500px",top: "2160px" ,position: "absolute" }} />,
<p style={{width: "50%", height: "00px", top: "2100px",right: "00px", position: "absolute"}}>Продукты "Происхождение"</p>]}
